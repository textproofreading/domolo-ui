<template>
    <div class="markdown px-6 xl:px-12 w-full max-w-3xl mx-auto lg:ml-0 lg:mr-auto xl:mx-0 xl:w-3/4">
        ...
        <div class="relative overflow-hidden mb-8">
            ...
            <div class="rounded-t-lg overflow-hidden border-t border-l border-r border-gray-400 bg-gray-200 px-8 py-12">
  ...
  <div class="max-w-sm mx-auto flex p-6 bg-white rounded-lg shadow-xl">
    ...
    <div class="ml-6 pt-1">
      <div class="text-xl text-gray-900 leading-tight">多么乐</div>
      <p class="text-base text-gray-600 leading-normal">探知资讯发生，跟踪事件变化!</p>
    </div>
  </div>
